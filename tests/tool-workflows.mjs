...
async function open(id) {
  if (failures.length) await assertClean(`before ${id}`);
...
await assertClean('architecture-builder workflow');
...
await assertClean('workflow-designer workflow');
...
await assertClean('seo-auditor workflow');
...
await assertClean('accessibility-lab workflow');
...
await assertClean('api-failure-lab workflow');
...
await assertClean('shader-lab workflow');
...
await assertClean('world-generator workflow');
